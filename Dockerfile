...
RUN cd /usr/local && tar -zxvf nexus-3.6.2-01-unix.tar.gz && rm -f nexus-3.6.2-01-unix.tar.gz && mv nexus-3.6.2-01-unix/ nexus/ && mv nexus/nexus-3.6.2-01 nexus/nexus3
